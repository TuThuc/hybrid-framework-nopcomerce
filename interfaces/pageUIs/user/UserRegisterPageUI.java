...
public class UserRegisterPageUI {
	...
	public static final String CONFIRM__PASSWORD = "//input[@id='ConfirmPassword']";
	...
	public static final String CONFIRM__PASSWORD_ERROR_MESSAGE = "//span[@id= 'ConfirmPassword-error']";
	public static final String REGISGER_SUCCESS_MESSAGE = "//div[@class='result']";
