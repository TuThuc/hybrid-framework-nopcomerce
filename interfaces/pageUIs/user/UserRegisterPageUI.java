...
public class UserRegisterPageUI {
	...
	public static final String CONFIRM__PASSWORD = "xpath=//input[@id='ConfirmPassword']";
	...
	public static final String CONFIRM__PASSWORD_ERROR_MESSAGE = "xpath=//span[@id= 'ConfirmPassword-error']";
	public static final String REGISGER_SUCCESS_MESSAGE = "xpath=//div[@class='result']";
