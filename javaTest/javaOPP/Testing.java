...
public class Testing extends Animal {
	...
	public static void main(String[] args) {
		...
		// // Không báo lỗi trong quá trình compile( trình biên dịch khi viết code sai)
		// // không đúng convention/ k đúng chuẩn của java nó sẽ báo lỗi ngay
		// // 2 loại lỗi
		// // lỗi compile : trong qua trình viết code sẽ báo lỗi
		// // lỗi runtime : trong quá trình mình run code
		// }
		//
		// @Override
